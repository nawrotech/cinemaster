 ...
 */
final class Version20241019122524 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cinema (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, slug VARCHAR(100) NOT NULL, max_rows INT NOT NULL, max_seats_per_row INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_D48304B45E237E06 (name), UNIQUE INDEX UNIQ_D48304B4989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE movie_movie_type ADD CONSTRAINT FK_96480618E5DACEBD FOREIGN KEY (movie_type_id) REFERENCES format (id)');

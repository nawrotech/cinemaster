 ...
 */
final class Version20241023082030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie_screening_format (id INT AUTO_INCREMENT NOT NULL, movie_id INT NOT NULL, screening_format_id INT NOT NULL, INDEX IDX_907F973A8F93B6FC (movie_id), INDEX IDX_907F973A80670753 (screening_format_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE screening_format (id INT AUTO_INCREMENT NOT NULL, language_presentation VARCHAR(255) NOT NULL, visual_format_id INT NOT NULL, cinema_id INT NOT NULL, INDEX IDX_3A404DABF4D381DB (visual_format_id), INDEX IDX_3A404DABB4CB84B6 (cinema_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE screening_room (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, slug VARCHAR(100) NOT NULL, status VARCHAR(100) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, maintenance_time_in_minutes INT DEFAULT NULL, cinema_id INT DEFAULT NULL, screening_room_setup_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_56558C8D5E237E06 (name), UNIQUE INDEX UNIQ_56558C8D989D9B62 (slug), INDEX IDX_56558C8DB4CB84B6 (cinema_id), INDEX IDX_56558C8DDBB9A999 (screening_room_setup_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE screening_room_setup (id INT AUTO_INCREMENT NOT NULL, sound_format VARCHAR(50) NOT NULL, visual_format_id INT NOT NULL, cinema_id INT NOT NULL, INDEX IDX_EDFF4DABF4D381DB (visual_format_id), INDEX IDX_EDFF4DABB4CB84B6 (cinema_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE showtime (id INT AUTO_INCREMENT NOT NULL, price INT NOT NULL, advertisement_time_in_minutes INT NOT NULL, slug VARCHAR(255) NOT NULL, is_published TINYINT(1) NOT NULL, starts_at DATETIME NOT NULL, ends_at DATETIME NOT NULL, screening_room_id INT NOT NULL, movie_screening_format_id INT NOT NULL, cinema_id INT NOT NULL, INDEX IDX_3248D9139B3F89 (screening_room_id), INDEX IDX_3248D91B107D596 (movie_screening_format_id), INDEX IDX_3248D91B4CB84B6 (cinema_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE visual_format (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(40) NOT NULL, cinema_id INT NOT NULL, INDEX IDX_A187A35DB4CB84B6 (cinema_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE movie_screening_format ADD CONSTRAINT FK_907F973A8F93B6FC FOREIGN KEY (movie_id) REFERENCES movie (id)');
        $this->addSql('ALTER TABLE movie_screening_format ADD CONSTRAINT FK_907F973A80670753 FOREIGN KEY (screening_format_id) REFERENCES screening_format (id)');
        ...
        $this->addSql('ALTER TABLE screening_format ADD CONSTRAINT FK_3A404DABF4D381DB FOREIGN KEY (visual_format_id) REFERENCES visual_format (id)');
        $this->addSql('ALTER TABLE screening_format ADD CONSTRAINT FK_3A404DABB4CB84B6 FOREIGN KEY (cinema_id) REFERENCES cinema (id)');
        ...
        $this->addSql('ALTER TABLE screening_room_setup ADD CONSTRAINT FK_EDFF4DABF4D381DB FOREIGN KEY (visual_format_id) REFERENCES visual_format (id)');
        $this->addSql('ALTER TABLE screening_room_setup ADD CONSTRAINT FK_EDFF4DABB4CB84B6 FOREIGN KEY (cinema_id) REFERENCES cinema (id)');
        ...
        $this->addSql('ALTER TABLE showtime ADD CONSTRAINT FK_3248D91B107D596 FOREIGN KEY (movie_screening_format_id) REFERENCES movie_screening_format (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie_screening_format DROP FOREIGN KEY FK_907F973A8F93B6FC');
        $this->addSql('ALTER TABLE movie_screening_format DROP FOREIGN KEY FK_907F973A80670753');
        ...
        $this->addSql('ALTER TABLE screening_format DROP FOREIGN KEY FK_3A404DABF4D381DB');
        $this->addSql('ALTER TABLE screening_format DROP FOREIGN KEY FK_3A404DABB4CB84B6');
        ...
        $this->addSql('ALTER TABLE screening_room_setup DROP FOREIGN KEY FK_EDFF4DABF4D381DB');
        $this->addSql('ALTER TABLE screening_room_setup DROP FOREIGN KEY FK_EDFF4DABB4CB84B6');
        $this->addSql('ALTER TABLE showtime DROP FOREIGN KEY FK_3248D9139B3F89');
        $this->addSql('ALTER TABLE showtime DROP FOREIGN KEY FK_3248D91B107D596');
